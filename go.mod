...
replace (
	github.com/coinbase/rosetta-sdk-go => github.com/coinbase/rosetta-sdk-go v0.7.0

	// Handle module v0.50.x compatibility issues
	...
	// Map IBC-Go v7 imports to v8
	github.com/cosmos/ibc-go/v7 => github.com/cosmos/ibc-go/v8 v8.6.1
