...
// GenerateGenesisState creates a randomized GenState of the kale-bank module.
...
// RandomizedParams creates randomized kale-bank param changes for the simulator.
func (AppModule) RandomizedParams(r *rand.Rand) []simtypes.ParamChange {
	return nil
}

// RegisterStoreDecoder registers a decoder for kale-bank module's types
func (am AppModule) RegisterStoreDecoder(sdr sdk.StoreDecoderRegistry) {
	// No store decoder needed
}

// WeightedOperations returns the all the kale-bank module operations with their respective weights.
